...
- [ ] (Optional: for ITS fungal metabarcoding) download [protaxFungi](https://github.com/psomervuo/protaxfungi) and unzip into a sister directory (i.e., `../protaxFungi`).
  ...
  ```
- [ ] download [usearch](https://drive5.com/usearch/) into `bin/`, and rename or link the executable to be called just `bin/usearch`. Make sure it is executable. Note that Usearch 12 is not supported.
  ```sh
...
- [ ] Install R dependencies.  This can be done in several ways:  
  ...
  ```
  As above for a standard conda installation, you may need to instead use `conda/OptimOTU_v6_full.yaml`. 
