...
- [ ] Install R dependencies.  This can be done in several ways:  
  ...
  In that case, you can instead use `conda env create -f conda/OptimOTU_v5_full.yaml`.
  ...
  ```
  As above for a standard conda installation, you may need to instead use `conda/OptimOTU_v5_full.yaml`. 
