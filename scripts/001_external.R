...
# hmmalign --outformat A2M -o hmmalign.out.a2m data/FinPROTAX/modelCOIfull/refs.hmm input.fasta

# run_hmmalign <- function(
#   file_R1, file_R2,
#   primer_R1, primer_R2,
#   trim_R1, trim_R2,
...
cutadapt_paired_filter_trim_rc <- function(
  file_R1, file_R2,
  primer_R1, primer_R2,
  trim_R1_rc, trim_R2_rc,
  max_err = NULL, min_overlap = NULL,
  action = NULL,
  discard_untrimmed = FALSE,
  max_n = NULL,
